...
const char * const BITCOIN_CONF_FILENAME = "ibithub.conf";
const char * const BITCOIN_PID_FILENAME = "ibithub.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ibithub";
#else
    // Unix
