...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ibithub-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ibithub-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ibithub transaction") + "\n" +
              "  ibithub-tx [options] -create [commands]   " + _("Create hex-encoded ibithub transaction") + "\n" +
              "\n";
